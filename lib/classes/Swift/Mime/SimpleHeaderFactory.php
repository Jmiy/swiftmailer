...
class Swift_Mime_SimpleHeaderFactory implements Swift_Mime_CharsetObserver
{
     ...
     */
    public function __construct(Swift_Mime_HeaderEncoder $encoder, Swift_Encoder $paramEncoder, EmailValidator $emailValidator, $charset = null, Swift_AddressEncoder|null $addressEncoder = null)
    {
     ...
     * @return Swift_Mime_Header
     */
    public function createDateHeader($name, DateTimeInterface|null $dateTime = null)
    {
